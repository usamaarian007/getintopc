      ...
      >
        <div className="p-4" style={{ width: "60vw" }}>
          ...
          <p className="pt-4 text-sm font-light">
            This Privacy Policy governs the manner in which Get into PC
            collects, uses, maintains and discloses information collected from
            users (each, a “User”) of the www.getintopc.com website (“Site”).
            This privacy policy applies to the Site and all products and
            services offered by Get into PC.
          </p>
          ...
          <p className="pt-3 text-sm font-semibold">Web browser cookies</p>
          <p
...
"
          >
            Get into PC may collect and use Users personal information for the
            following purposes: <br /> – To improve customer service Information
            ...
            products and services. – To send periodic emails We may use the
            email address to respond to their inquiries, questions, and/or other
            requests.
            <p
              className="pt-3 text-sm font-semibold
"
...
"
          >
            ...
            stored on our Site. <br /> Our Site is in compliance with PCI
...
"
          >
            ...
            ad and content network privacy policy atÂ
...
"
          >
            Get into PC has the discretion to update this privacy policy at any
